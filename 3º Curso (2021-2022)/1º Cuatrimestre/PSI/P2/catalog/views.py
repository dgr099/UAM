...
# similar a lo anterior para los libros pero esta vez para los autores
...
class AuthorDetailView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['book_list'] = Book.objects
        return context
...
def index(request):
    ...
    num_gen = Genre.objects.count()
    num_book_contain_a = Book.objects.filter(title__contains='a').count()

...
class Cloze(question: String,
    ...
    companion object{
        fun fromString(cad: String) : Card{
            ...
            return Cloze(question = atr[0], answer=atr[1], date=atr[2], id=atr[3], quality=atr[4].toIntOrNull()?:0, repetitions=atr[5].toIntOrNull()?:0, interval=atr[6].toLongOrNull()?:0, nextPracticeDate= atr[7], easiness=atr[8].toDoubleOrNull()?:0.0, idDeck=atr[9])
        }
    }
}

...
import es.uam.eps.dadm.myapplication.databinding.ActivityCreateDeckBinding
import timber.log.Timber
//private const val ANSWERED_KEY = "es.uam.eps.dadm.cards:answered"
class CreateDeckActivity : AppCompatActivity() {
    lateinit var binding: ActivityCreateDeckBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_create_deck)

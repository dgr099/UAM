...
public class Camion extends Vehiculo {
	...
	/**
	 * Constructor de camión pasando su velocidad máxima
	 * @param maxSpeed velocidad maxima del camion
	 */
	public Camion(double maxSpeed) {
    ...
    /**
	 * Metodo para obtener el estado de caducidad de la ITV en un camin
	 * 
	...
	/**
	 * Método para actualizar la posición del camión
	 */
	@Override
	public void updatePosition() {
		...
		if(i<=8) { //si sale un numero del 0 al 8 (9 de 10 opcs, 90%) se mueve a max vel
			...
			this.setActualPosition(this.getActualPosition() + this.getMaxSpeed() * 80/100);
		}
		return;

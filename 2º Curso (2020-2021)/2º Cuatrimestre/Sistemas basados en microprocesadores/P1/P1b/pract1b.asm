...
INICIO PROC
    ...
    ;MOV [TABLA200 + 63h], ERRORTOTAL1[3] ;Esto no se puede, necesitas pasar por registro para emplear mov
    ...
    MOV [TABLA200 + 23h], AL ;Copiamos el más significativo en la posición más pequeña (little endian)
    MOV [TABLA200 + 23h + 1h], AH ;El más significativo en la más alta
    ;MOV WORD PTR [TABLA200 + 23h], AX También válido así

...
/**
* @brief Gets the id of the previous node
* @param n Node address
* @return Returns the id of the previous node, or -1 in case of error
*/
long node_getPredecessorId (const Node *n);

/**
* @brief Sets the id of the previous node
* @param n Node address
* @param predid Id to be set
* @return Returns OK or ERROR in case of error
*/

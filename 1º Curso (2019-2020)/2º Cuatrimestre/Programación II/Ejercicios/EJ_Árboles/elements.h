...
/**
 * @brief  This function initializes a stack element of type int.
 * @param a Value of the integer
 * @return   This function returns a pointer to the element
...
/**
 * @brief  This function initializes a stack element of type char.
 * @param a Value of the char
 * @return   This function returns a pointer to the element
 * if insufficient memory is available to create the stack.
 *  */
 ...
 * if insufficient memory is available to create the char.
 *  */
...
/**
 * @brief  This function initializes a stack element of type float.
 * @param a Value of the float
 * @return   This function returns a pointer to the element
 * if insufficient memory is available to create the stack.
 *  */
 ...
 * if insufficient memory is available to create the float.
 *  */

...
* @param  id the id of the element that you want to add
* @return Ok if there was no problem,
*/
...
/**
*@brief update a set with a new set
*
* set_update
*
* @date 26-04-2020
* @author: David Teófilo Garitagoitia Romero
*
* @param original the set which you want to update
* @param final the set with the new info
* @return
*/

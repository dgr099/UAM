...
/**
 * @test Test the function to set the ilumination of a space
 * @pre The ilumination you want to set
 * @post The output must be OK
 */
...
/**
 * @test Test the function to set the ilumination of a space
 * @pre The ilumination you want to set but the space is a NULL pointer
 * @post The output must be ERROR
 */
void test2_space_set_ilumination();

/**
 * @test Test the function to set the description1 of a space
 * @pre The description you want to set
 * @post The output must be OK
 */
...
/**
 * @test Test the function to set the description1 of a space
 * @pre The description you want to set but the space is a NULL pointer
 * @post The output must be ERROR
 */
...
/**
 * @test Test the function to set the description1 of a space
 * @pre The description is NULL
 * @post The output must be ERROR
 */
void test3_space_set_description1();

/**
 * @test Test the function to get the description1 of a space
 * @pre The description and the space
 * @post The output must be the description you have set before
 */
void test1_space_get_description1();

/**
 * @test Test the function to get the description1 of a space
 * @pre The space is a NULL pointer
 * @post The output must be NULL
 */
void test2_space_get_description1();

/**
 * @test Test the function to set the description2 of a space
 * @pre The description you want to set
 * @post The output must be OK
 */
...
/**
 * @test Test the function to get the description2 of a space
 * @pre The description and the space
 * @post The output must be the description you have set before
 */

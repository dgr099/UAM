 ...
 * 
 * @file inventory.h
 * @author Diego Grande Camarero, David Teófilo Garitagoitia Romero y Daniel Cerrato Sánchez
 * @version 1.0 
 * @date 13-03-2020 
...
/**
 * @brief Return the id of the inventory
 *
 * inventory_get_id Return the id of the inventory
 *
 * @date 10-06-2020

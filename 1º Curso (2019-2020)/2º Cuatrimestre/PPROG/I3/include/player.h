...
* @param max the maximum number of objects that can have the player
...
* @param id the id that the player will have
* @return ERROR if there is an error, otherwise return OK
*/
...
* @author: David Teófilo Garitagoitia Romero
*
* @param player the player whose id is desired
...
* @author: David Teófilo Garitagoitia Romero
*
* @param player the player that has been created before
* @return ERROR if there is an error, otherwise return OK
*/

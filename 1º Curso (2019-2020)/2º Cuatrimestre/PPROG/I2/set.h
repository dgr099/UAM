...
* @author: David Teófilo Garitagoitia Romero
*
* @param: the addres of the set which you want to print
...
* @author: David Teófilo Garitagoitia Romero
*
* @param: the addres os the set in which you want to add an element and the id of them
* @return Ok if there was no problem,
*/
...
* @param file in which you want to print and set which have the elements
* @return
*/
